...
class ListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val query = db.collection("restaurants").orderBy("rating", Query.Direction.DESCENDING)
    ...
    private inner class RestaurantAdapter internal constructor(options: FirestoreRecyclerOptions<Restaurant>) :
        ...
        override fun onBindViewHolder(
            ...
            holder.itemView.ratingBar.rating =
                    model.rating!!.toFloat() // convert to float to match RatingBar.rating type
            ...
            holder.itemView.setOnClickListener {
                ...
                intent.putExtra("restaurantName", model.name)
                startActivity(intent)
            }
        }
    }
